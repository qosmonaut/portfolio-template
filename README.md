...
<p align="center">
  <a href="https://qosmonaut.github.io/portfolio-template">See live</a>
</p>
...
* Simple and easy to edit - your version is up and running in minutes.
  ...
  - Add multiple languages with custom translations.
...
```bash
# Fork (or create from template) and clone repo
...
2. Add your personal details by editing `translations/en.json`
   ...
   - You can add files such as pictures for the project gallery, or CV in PDF format in the public folder.
   - You can add languages by duplicating the file and adding a button to the language switcher (`components/language-switcher.jsx`) 
