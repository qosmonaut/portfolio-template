...
const Socials = (props) => {
    return (
        <div className='flex flex-col items-center justify-center gap-4'>
            {props.data.booking.link && <a href={props.data.booking.link} target="_blank" className='bg-primary-50 hover:bg-primary-100 text-primary-300 flex w-full flex-row items-center justify-center rounded px-4 py-2 font-bold transition-all duration-300 hover:shadow-lg'>
