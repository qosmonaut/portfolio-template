...
function EducationItem(props) {
    ...
    const logoImage = props.logo && (
        <Image src={props.logo} alt={props.university} width={100} height={100} className='mb-4 w-25 object-contain transition-all duration-300 group-hover:scale-110 group-hover:brightness-110' />
    );
